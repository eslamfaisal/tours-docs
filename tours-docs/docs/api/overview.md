...
The Swagger UI includes an **Authorize** button. Click it and enter your JWT token (e.g., `eyJhbG...`) to access protected endpoints.

**Default Super Admin Credentials:**
- **Email**: `super@egypttours.com`
- **Password**: `super123`

Use these credentials to login via `POST /api/v1/auth/login` and obtain a token.
